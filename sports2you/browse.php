    ...
    <div class="dashboard-card">
        ...
        <div class="filters-container">
            ...
            <div class="form-group">
                ...
                <input type="text" id="searchFilter" class="form-control" placeholder="Search by location, sport, or creator">
            </div>
        </div>
    </div>
            ...
            <?php else: ?>
                <div class="game-cards">
                    <?php foreach ($games as $game): ?>
                        <div class="game-card" data-sport-id="<?php echo $game['sport_id']; ?>" data-skill-level="<?php echo $game['skill_level_required']; ?>">
